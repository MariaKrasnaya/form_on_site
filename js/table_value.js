document.addEventListener("DOMContentLoaded", function () {
  ...
  table_button.addEventListener("click", function () {
    ...
    let disc = document.querySelector("input[name='disc']").value;
    ...
    document.querySelector("input[name='disc']").selectedIndex = 0;
    document.querySelector("input[name='type']").selectedIndex = 0;
  });
});
